...
export const ServicesPage = () => {
  ...
  >
            <div>
              <div className="mb-8 w-20 h-20 rounded-3xl bg-purple-100 flex items-center justify-center text-purple-600">
                <HelpCircle className="h-10 w-10" />
              </div>
              <h3 className="text-3xl font-extrabold text-slate-900 font-poppins mb-4">Other Billing Issue</h3>
              <p className="text-slate-600 mb-6 leading-relaxed">
                Report any other unlisted billing concerns, fees, or miscellaneous account issues. Simply provide a description of the problem for our team to review.
              </p>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-center gap-3 text-sm text-slate-600">
                  <CheckCircle2 className="h-5 w-5 text-purple-600 flex-shrink-0" />
                  <span>Quick text description submission</span>
                </div>
                <div className="flex items-center gap-3 text-sm text-slate-600">
                  <CheckCircle2 className="h-5 w-5 text-purple-600 flex-shrink-0" />
            ...
            <Link to="/services/other-billing">
              <button className="w-full py-4 px-6 rounded-2xl bg-purple-600 hover:bg-purple-700 text-white font-bold transition-all flex items-center justify-center gap-2 group">
                View Details <ArrowRight className="h-5 w-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </Link>
          </motion.div>
        </div>
